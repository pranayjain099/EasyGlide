...
<div class="easy-glide flexslider <?php echo (isset(Easy_Glide_Settings::$options['easy_glide_style'])) ? esc_attr(Easy_Glide_Settings::$options['easy_glide_style']) : 'style-1'; ?>">
